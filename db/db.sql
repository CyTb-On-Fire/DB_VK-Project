...
create index on post (thread_id, id, parent_id NULLS FIRST);
create index on post (path, (path[1]), id);
create index on post ((path[1]), thread_id, id, parent_id NULLS FIRST);
